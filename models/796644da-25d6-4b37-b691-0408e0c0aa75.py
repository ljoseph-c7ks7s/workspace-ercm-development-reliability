...
add_label_add_split = Table('add_label_add_split', metadata, 
    ...
    Column('label', String(255), primary_key=False, autoincrement=False),
    Column('Position', String(255), primary_key=False, autoincrement=False),
    Column('RC', String(255), primary_key=False, autoincrement=False),
    Column('prediction', String(255), primary_key=False, autoincrement=False),
    Column('train_test', String(255), primary_key=True, autoincrement=False)
)