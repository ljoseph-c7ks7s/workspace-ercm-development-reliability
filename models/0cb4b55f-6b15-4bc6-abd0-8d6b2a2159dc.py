...
remis_prp4127 = Table('remis_prp4127', metadata,
    ...
    Column('Component_Part_Number', String(255)),
    Column('Component_Serial_Number', String(255)),
    ...
    Column('Installed_Serial_Number', String(255)),
    ...
    Column('Installed_Location_Identifier', String(255)),
    ...
    Column('Removed_Serial_Number', String(255)),
    ...
    Column('Removed_Location_Identifier', String(255)),
    ...
    Column('Installed_EI_Serial_Number', String(255)),
    Column('Installed_EI_SRD', String(3)),
    Column('Installed_EI_Type_Equipment', String(1)),
    Column('Installed_EI_Work_Unit_Code', String(45)),
    Column('Installed_EI_Comp_Part_Number', String(255)),
    Column('Installed_EI_Comp_Serial_Number', String(255)),
