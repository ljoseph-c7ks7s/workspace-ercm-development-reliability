...
c130_g081_sortie_data = Table('c130_g081_sortie_data', metadata, 
    ...
    Column('Serial_Number', String(15), primary_key=False, autoincrement=False),
    ...
    Column('Depart_Time', Integer, primary_key=False, autoincrement=False),
    ...
    Column('Land_Time', Integer, primary_key=False, autoincrement=False),
